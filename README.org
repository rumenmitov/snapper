...
#+begin_src shell
  git clone -b sculpt-25.10.1 https://github.com/genodelabs/genode.git
...
#+begin_src shell
  ...
  goa update-goa 25.10 || (echo "Could not update goa to required version!" && exit 1)

  /genode/tool/ports/prepare_port lwext4
  DEPOT_DIR=/genode/repos/snapper/var/depot goa depot-dir
  DEPOT_DIR=/genode/repos/snapper/var/depot FORCE_VERSION=2026-04-22 /genode/tool/depot/create rumen/bin/x86_64/vfs_lwext4
